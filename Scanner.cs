...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 106; i <= 111; ++i) start[i] = 1;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 23:
				{t.kind = 23; break;}
			case 24:
				if (ch == '_') {AddCh(); goto case 25;}
				else {goto case 0;}
			case 25:
				if (ch == '_') {AddCh(); goto case 26;}
				else {goto case 0;}
			case 26:
			...
			case 30:
				if (ch == '_') {AddCh(); goto case 31;}
				else {goto case 0;}
			case 31:
				if (ch == '_') {AddCh(); goto case 32;}
				else {goto case 0;}
			case 32:
			...
			case 46:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); goto case 1;}
				else if (ch == 't') {AddCh(); goto case 48;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 47:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 1;}
